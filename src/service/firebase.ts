...
import { onValue, ref, set, update, getDatabase, get } from 'firebase/database'
...
interface IUpdateUserData {
  ...
  watchedAnimes?: object
  myListAnimes?: object
  myListfriends?: object
  watchingEpisodes?: object
}
...
export function addCommentEpisode(
  userId: string,
  episodeId: string,
  text: string,
) {
